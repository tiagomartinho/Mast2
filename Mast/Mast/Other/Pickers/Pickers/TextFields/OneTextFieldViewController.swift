...
extension UIAlertController {
    ...
    public func addOneTextField(configuration: TextField1.Config?) {
...
final public class OneTextFieldViewController: UIViewController {
    ...
    fileprivate lazy var textField: TextField1 = TextField1()
    ...
    public init(vInset: CGFloat = 12, configuration: TextField1.Config?) {
