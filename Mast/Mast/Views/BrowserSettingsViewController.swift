...
class BrowserSettingsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var allBrowsers: [String] = ["Safari", "Chrome", "Firefox", "Opera", "Dolphin", "Brave", "In-App"]
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        DispatchQueue.main.async {
            UserDefaults.standard.set(indexPath.row, forKey: "sync-chosenBrowser")
            self.tableView.reloadData()
        }
    }
}
