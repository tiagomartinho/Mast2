...
//  Mast
//
//  Created by Shihab Mehboob on 26/11/2019.
...
class KeyboardSettingsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var allBrowsers: [String] = ["Default".localized, "Social".localized]
    ...
    override func viewDidLoad() {
        ...
        self.title = "Default Keyboard".localized
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return self.allBrowsers.count
    }
    
    func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        if indexPath.row == (UserDefaults.standard.value(forKey: "sync-chosenKeyboard") as! Int) {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        DispatchQueue.main.async {
            UserDefaults.standard.set(indexPath.row, forKey: "sync-chosenKeyboard")
            self.tableView.reloadData()
        }
    }
}
