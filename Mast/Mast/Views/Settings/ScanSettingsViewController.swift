...
class ScanSettingsViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var allBrowsers: [String] = ["Accurate".localized, "Fast".localized]
    ...
    override func viewDidLoad() {
        ...
        self.title = "Default Scan Mode".localized
    ...
    func tableView(_ tableView: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        if indexPath.row == (UserDefaults.standard.value(forKey: "sync-scanMode") as! Int) {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        DispatchQueue.main.async {
            UserDefaults.standard.set(indexPath.row, forKey: "sync-scanMode")
            self.tableView.reloadData()
        }
    }
}
