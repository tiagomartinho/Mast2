...
class TootViewController: UIViewController, UITextViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLayoutSubviews() {
        ...
        self.divider.frame = CGRect(x: CGFloat(0), y: CGFloat(keyboardY2), width: CGFloat(UIScreen.main.bounds.width), height: CGFloat(1))
    }
    ...
    override func viewDidLoad() {
        ...
        self.divider.backgroundColor = UIColor(named: "baseBlack")!.withAlphaComponent(0.4)
