...
class PollOptionCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        theOption.textColor = UIColor(named: "baseBlack")!.withAlphaComponent(0.45)
        ...
        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-18-[optionCount]-(>=18)-|", options: [], metrics: nil, views: viewsDict))
        contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-18-[theOption]-18-|", options: [], metrics: nil, views: viewsDict))
